...
API_ID = int(environ.get('API_ID', '7701953107'))
API_HASH = environ.get('API_HASH', '5e7701953107a273724b07f2beaf8f17')
BOT_TOKEN = environ.get('BOT_TOKEN', "6513440724:AAH0EGqjCATl-azX89Y2Uemi3OP-BRjzoZs")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002048183700'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002048183700') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002002455446')
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001898822234')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002048183700')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://lorif98732:dvl_naruto_6@cluster0.e8lyfva.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ARAKAL_THERAVAD_GROUP_02')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Free_Fire_Max_Id_Stores')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'ARAKAL_THERAVAD_GROUP_02') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Sujan_x')
